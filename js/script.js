...
function initializeAnimationObservers() {
  const animateElements = document.querySelectorAll(
    ".skill-category, .project-card, .stat, .contact-method",
  );
...
const animatedPhrases = [
  ...
  {
    text: "derives insights from complex data.",
    font: "'IBM Plex Mono', monospace",
  },
  {
    text: "turns caffeine into clean code.",
    font: "'IBM Plex Mono', monospace",
  },
  { text: "believes in value investing.", font: "'IBM Plex Mono', monospace" },
  {
    text: "finds beauty in Euler's number.",
    font: "'IBM Plex Mono', monospace",
  },
  {
    text: "rejects null hypotheses confidently.",
    font: "'IBM Plex Mono', monospace",
  },
  {
    text: "solves PDEs with a cup of tea.",
    font: "'IBM Plex Mono', monospace",
  },
  {
    text: "achieves Pareto optimality daily.",
    font: "'IBM Plex Mono', monospace",
  },
  {
    text: "solves optimization problems elegantly.",
    font: "'IBM Plex Mono', monospace",
  },
];
...
function shouldShowLoaderForLink(link) {
  ...
  const isDownloadLink =
    link.hasAttribute("download") || /\.(pdf|doc|zip)$/i.test(href);
  const isExternalLink =
    href.startsWith("http") && !href.includes(window.location.hostname);
  const isSocialMediaLink = /(linkedin|instagram|github)\.com|mailto:/.test(
    href,
  );

  return (
    !isGoingToHome && !isDownloadLink && !isExternalLink && !isSocialMediaLink
  );
}
  ...
  projectCards.forEach((card) => {
    card.addEventListener("click", () => {
      ...
      const fullDescription =
        descriptionElement.getAttribute("data-full-text") ||
