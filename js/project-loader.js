class ProjectLoader {
  ...
  getSkillCategory(skill) {
    ...
    if (
      ...
      skillLower.includes("mathematical") ||
      skillLower.includes("econometric") ||
      skillLower.includes("modeling") ||
      skillLower.includes("analysis") ||
      skillLower.includes("quantitative") ||
      skillLower.includes("forecasting") ||
      skillLower.includes("time series")
    ) {
      return "mathematics";
    }

    if (
      skillLower.includes("economic") ||
      skillLower.includes("financial") ||
      skillLower.includes("policy") ||
      skillLower.includes("derivatives") ||
      skillLower.includes("monetary") ||
    ...
    if (
      ...
      skillLower.includes("strategic") ||
      skillLower.includes("mentorship") ||
